<div>
    ...
    @if (session('success'))
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 8000)"
            class="mb-3 flex items-center gap-2 rounded-lg bg-green-50 border border-green-200 px-4 py-3 text-sm text-green-700">
    ...
    @if ($waLink)
        <a href="{{ $waLink }}" target="_blank" rel="noopener"
            class="mb-4 flex items-center justify-center gap-2 rounded-lg bg-green-500 hover:bg-green-600 active:bg-green-700 text-white font-semibold px-4 py-3 text-sm transition-colors shadow-sm">
