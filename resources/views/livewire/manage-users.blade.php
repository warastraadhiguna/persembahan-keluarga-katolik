            ...
            <form wire:submit="resetPassword" class="px-6 py-5 space-y-4">
                <div>
                    ...
                    <input wire:model="newPassword" type="password" placeholder="Min. 8 karakter"
                        class="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('newPassword') border-red-300 @enderror">
