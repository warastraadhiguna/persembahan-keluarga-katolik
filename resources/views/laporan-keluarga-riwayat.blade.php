<x-main-layout>
    ...
    {{-- Kartu info keluarga + tombol ekspor --}}
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-5">
        <div class="flex items-end justify-between gap-4">
            ...
            <div class="flex gap-2 shrink-0">
                <a href="{{ route('laporan.keluarga.excel', $family) }}"
                ...
                <a href="{{ route('laporan.keluarga.pdf', $family) }}"
    ...
    <livewire:family-transaction-history :family="$family" :readOnly="true" />
</x-main-layout>
